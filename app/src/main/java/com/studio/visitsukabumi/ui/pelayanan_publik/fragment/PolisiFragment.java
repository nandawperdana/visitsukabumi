...
public class PolisiFragment extends Fragment {
    ...
    List<PelayananPublikModel> listItems;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                PelayananPublikModel item = listItems.get(position);
                openDetails(item);
            }
        }));
    }
    ...
    private void init(View view) {
        ...
        this.listItems = ((PelayananPublikActivity) getActivity()).doRetrieveModel().getListPelayananPublikPolisi();
        initLayout(view);
    }
