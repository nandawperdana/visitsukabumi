 ...
 */
public class LautPantaiFragment extends Fragment {
    // views
    ...
    private void init(View view) {
        this.listItems = ((ObjekWisataActivity) getActivity()).doRetrieveModel().getListObjekLautPantai();
        initLayout(view);
    }
