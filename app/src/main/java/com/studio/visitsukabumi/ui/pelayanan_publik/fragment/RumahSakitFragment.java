package com.studio.visitsukabumi.ui.pelayanan_publik.fragment;
...
public class RumahSakitFragment extends Fragment {
    ...
    List<com.studio.visitsukabumi.api.v1.pelayananpublik.PelayananPublikModel> listItems;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                com.studio.visitsukabumi.api.v1.pelayananpublik.PelayananPublikModel item = listItems.get(position);
                openDetails(item);
            }
        }));
    }
    ...
    private void init(View view) {
        ...
        this.listItems = ((PelayananPublikActivity) getActivity()).doRetrieveModel().getListPelayananPublikRumahSakit();
        initLayout(view);
    }
    ...
    public void showItems() {
        if (listItems.isEmpty())
            ...
            listItemShow.clear();
            for (PelayananPublikModel item : listItems) {
